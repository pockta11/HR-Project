                ...
                <div class="d-none d-md-block">
                  <ul class="pagination justify-content-center">
                    <c:choose>
                      ...
                      <c:otherwise>
                        <li href="${root }notice/sub_read/noticeSubDetail?board_info_idx=${board_info_idx}&page=${pageBean.prevPage}" class="page-item disabled"><a href="#" class="page-link">이전</a></li>
                      </c:otherwise>
                    </c:choose>
                    ...
                    <c:choose>
                      ...
                      <c:otherwise>
                        <li class="page-item"><a href="${root }notice/sub_read/noticeSubDetail?board_info_idx=${board_info_idx}&page=${pageBean.nextPage}" class="page-link">다음</a></li>
                      </c:otherwise>
                    </c:choose>
                  </ul>
                </div>
