                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <div class="text-right">
                      <a style="background-color:#415971; color:white; margin-top:15px;" href="${root }notice/sub/noticeSub?board_info_idx=${board_info_idx}&page=${page}" class="btn">목록보기</a>
                      <a style="background-color:#46649B; color:white; margin-top:15px;" href="${root }notice/sub/modify?board_info_idx=${board_info_idx}&content_idx=${content_idx}&page=${page}" class="btn">수정하기</a>
                      <a style="background-color:#CD426B; color:white; margin-top:15px;" href="${root }notice/sub/delete?board_info_idx=${board_info_idx}&content_idx=${content_idx}&page=${page}" class="btn">삭제하기</a>
                    </div>
                  </div>
                </div>
              </div>
