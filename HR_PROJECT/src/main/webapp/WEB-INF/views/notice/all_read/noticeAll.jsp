                ...
                <tbody>
                  <c:forEach items="${contentList}" var="obj">
                    <tr>
                      ...
                      <td><a style="color: navy; text-decoration: none;" href="${root}notice/all_read/read?board_info_idx=1&content_idx=${obj.content_idx}">${obj.content_subject}</a></td>
                ...
                <ul class="pagination justify-content-center">
                  ...
                  <c:forEach var="idx" begin="${pageBean.min }" end="${pageBean.max }">
                    <c:choose>
                      ...
                      <c:otherwise>
                        <li class="page-item"><a href="${root }notice/all_read/noticeAll?board_info_idx=${board_info_idx}&page=${idx}" class="page-link" style="color: #415971;">${idx }</a></li>
                      </c:otherwise>
                    </c:choose>
                  </c:forEach>
