      ...
      <div class="row">
         ...
         <div class="col-sm-6">
            <div class="card shadow">
               <div class="card-body">
                  <form:form action="${root }notice/all_read/modify_pro" method="post" modelAttribute="modifyContentBean" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        <div class="text-right">
                           ...
                           <a href="${root }notice/all_read/read?board_info_idx=${board_info_idx}&content_idx=${content_idx}&page=${page}" class="btn btn-info">취소</a>
                        </div>
                     </div>
                  </form:form>
               </div>
